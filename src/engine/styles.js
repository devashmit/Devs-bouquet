...
export const STYLE_MODES = {
  sketch: {
    ...
    colors: {
      ...
      filler_leaf: { stroke: '#d6b880', fill: '#fffce8', petals: ['#fffce8', '#f5f0e1', '#ffe5b4'], stemLine: '#6b8e5c', leafFill: ['#8ba87f', '#a3c296', '#729661'] },
  ...
  mono: {
    ...
    colors: {
      ...
      filler_leaf: { stroke: '#4a4a4a', fill: '#e8e8e8', petals: ['#e8e8e8', '#f0f0f0'], stemLine: '#5a5a5a', leafFill: ['#a0a0a0', '#909090'] },
  ...
  pastel: {
    ...
    colors: {
      ...
      filler_leaf: { stroke: '#e0d8b0', fill: '#fcf8eb', petals: ['#fcf8eb', '#fdfcee'], stemLine: '#a0c0a0', leafFill: ['#c8e0c8', '#dcf0dc', '#b8d6b8'] },
